...
const Hero: NextPage = () => {
    ...
    return <>
        <div className="z-1 relative flex flex-col min-h-screen">
            <h1 className="lg:text-xl text-orange-400/95 font-semibold animate-fade-up-in" style={{ animationDelay: "400ms", animationFillMode: "backwards", fontFamily: "var(--font-mono)", fontWeight: 400 }}>
                Hi, my name is
            </h1>
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl text-gray-300/60 font-semibold my-2 animate-fade-up-in" style={{ animationDelay: "575ms", animationFillMode: "backwards" }}>
                I build chat{' '}bots
            </h1>
        </div>
    </>;
